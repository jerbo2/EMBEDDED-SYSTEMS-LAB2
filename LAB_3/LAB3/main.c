...
void gpioInit(){
    ...
    P6SEL0 |= BIT0;                        // Select bits for P6
    P6SEL1 &= ~BIT0;                       // Clear
    P1SEL0 |= BIT1;                        // Select bits for P1
    P1SEL1 |= BIT1;                        // "                 "
...
void setLEDBrightness(int Dutycycle){
    TB3CCR1 = Dutycycle;                // Adjust duty cycle CCR based on duty cycle integer
}
